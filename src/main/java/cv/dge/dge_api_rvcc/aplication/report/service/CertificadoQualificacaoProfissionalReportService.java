package cv.dge.dge_api_rvcc.aplication.report.service;

import cv.dge.dge_api_rvcc.aplication.report.dto.CandidatoReportDto;
import cv.dge.dge_api_rvcc.aplication.report.dto.CertificadoQualificacaoProfissionalReportResponse;
import cv.dge.dge_api_rvcc.aplication.report.dto.EntidadeFormadoraReportDto;
import cv.dge.dge_api_rvcc.aplication.report.dto.QualificacaoReportDto;
import cv.dge.dge_api_rvcc.aplication.report.dto.UnidadeCompetenciaReportDto;
...
public class CertificadoQualificacaoProfissionalReportService {
    ...
    public Optional<CertificadoQualificacaoProfissionalReportResponse> obterDados(
        ...
        Map<String, Object> campos = montarCampos(dado, unidades, dataEmissao, numeroCertificado);
    ...
    private DadosCertificado mapDadosCertificado(ResultSet rs, int rowNum) throws SQLException {
        CandidatoReportDto candidato = new CandidatoReportDto(
                ...
                naturalidadeRelatorio(rs.getString("naturalidade"), rs.getString("concelho"), rs.getString("nacionalidade")),
